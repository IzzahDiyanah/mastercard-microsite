    ...
    <div className="relative max-h-screen bg-gradient-to-br from-orange-600 to-red-600 overflow-hidden">
      ...
      <main className="relative z-10 px-4 md:px-8 py-8 md:py-16 max-w-7xl mx-auto">
        <div className="max-w-2xl">
          <p className="text-white/90 text-sm md:text-lg mb-4 md:mb-8 tracking-wide">SAFETY AND SECURITY</p>
          
          <h1 className="text-3xl md:text-6xl font-extrabold text-yellow-400 leading-tight mb-4 md:mb-8">
            Social Intelligence<br />
            Report 2024
          </h1>
          
          <p className="text-white/90 text-lg md:text-xl mb-8 md:mb-12 font-light">
            Singapore | OCT 2023 - MAR 2024
          </p>
          
          <button className="inline-flex items-start md:items-center flex-col md:flex-row px-4 md:px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg transition-colors shadow-lg w-full md:w-auto">
