    ...
    <section className="w-full min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-3/5 flex flex-col">
        ...
        <div className="h-auto lg:h-1/2 bg-gradient-to-b from-[#973f0b] to-amber-950 p-6 md:p-12 lg:p-23 text-white relative">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-normal mb-6 lg:mb-8 max-w-xl text-white">
          ...
          {/* Social Icons Grid - Responsive Version - Simpler 3-col mobile approach */}
            <div className="flex flex-col items-center mt-8 lg:mt-0">
              ...
              <div className="grid grid-cols-3 gap-8 max-w-2xl md:hidden">
              ...
              <div className="hidden md:block">
                {/* Top Row - 4 icons */}
                <div className="grid grid-cols-4 gap-16 lg:gap-36 max-w-4xl mb-4">
                ...
                <div className="flex justify-center w-full mt-4 lg:-mt-25">
                  <div className="grid grid-cols-3 gap-16 lg:gap-36 max-w-2xl">
          ...
          {/* NEW Badge */}
          <div className="absolute -bottom-7.5 right-4 lg:-bottom-13 lg:right-15 w-20 h-8 lg:w-35 lg:h-14 bg-white text-orange-500 rounded-b-2xl lg:rounded-b-3xl flex items-center justify-center font-extrabold text-lg lg:text-2xl">
            NEW
          </div>
        </div>
        ...
        <div className="h-auto lg:h-1/2 bg-gradient-to-b from-[#F79E1B] to-[#FF5F00] p-6 md:p-12 lg:p-23 flex items-center">
          <div className="space-y-4 lg:space-y-6">
            <div className="flex flex-col md:flex-row items-center gap-3 md:gap-5">
              ...
              />
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-gray-900 text-center md:text-left">
                Mastercard Cyber Insights
              </h1>
            </div>
            <div className="text-gray-900 leading-relaxed text-lg md:text-xl lg:text-2xl xl:text-3xl max-w-4xl">
              <p>
